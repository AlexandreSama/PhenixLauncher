package fr.alexandre.phenixlauncher;

import fr.alexandre.phenixlauncher.ui.PanelManager;
import fr.alexandre.phenixlauncher.ui.panels.pages.App;
import fr.alexandre.phenixlauncher.ui.panels.pages.Login;
import fr.alexandre.phenixlauncher.utils.Helpers;
...
public class Launcher extends Application {
    ...
    private final File launcherDir = Helpers.generateGamePath("PhenixLauncher");
    ...
    public Launcher() {
        instance = this;
        this.logger = new Logger("[PhenixLauncher]", new File(this.launcherDir, "launcher.log"));
